...
public class GridContractAddImageAdapter extends BaseAdapter {

    //默认上传最大数值
    private String TAG = "GridViewContractAddImageAdapter";
    ...
    public GridContractAddImageAdapter(List<String> datas, Context context) {
        this.datas = datas;
